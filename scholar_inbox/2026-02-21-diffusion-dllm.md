---
title: "2026-02-21-diffusion-dllm"
---

# Scholar Inbox 精选 - 2026-02-21

## Diffusion / dLLM / 表征相关论文（ranking_score >= 0.85）

> ⚠️ 今日 digest 与 02-20 高度重叠（周末效应），高分论文与昨日相同。以下保留完整记录供参考。
...
**亮点：** 连续流在 one-hot 空间上的建模 + 蒸馏到 flow map 的思路非常优雅，代码已开源（[github.com/david3684/flm](https://github.com/david3684/flm)）。对 diffusion + representation 研究方向高度相关——如果连续流能在离散模态上胜出，dLLM 的理论基础和实践路线都需要重新审视。
...
**亮点：** Block decomposition 缓解同步误差的思路可能对其他需要精确输出的 dLLM 应用（代码生成、数学推理）有启发。扩散模型在"确定性生成"场景下的优势和陷阱值得关注。
...
*今日 digest 共 7 篇论文，2 篇 ≥ 0.85，1 篇 borderline。与 02-20 digest 完全重叠（周末无新论文入库）。*
